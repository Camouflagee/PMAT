...
def get_config():
    ...
    parser.add_argument("--rank_layer_N", type=int, default=2,
                    help="Number of layers for the scoring network")
    ...
    parser.add_argument("--ranking_loss_coef", type=float,
                        default=1, help='ranking loss coefficient (default: 1)')
