...
class TransformerPolicy:
    ...
    def get_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, masks, available_actions=None,
        ...
        actions, action_log_probs, values, seq_log_probs, seqs = self.transformer.get_actions(cent_obs,
                                                                         obs,
                                                                         available_actions,
                                                                         deterministic)
    ...
    def evaluate_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, actions, seqs, masks,
        ...
        action_log_probs, values, entropy, seq_log_probs, seq_entropy = self.transformer(cent_obs, obs, actions, seqs, available_actions)
    ...
    def act(self, cent_obs, obs, rnn_states_actor, masks, available_actions=None, deterministic=True):
        ...
        _, actions, _, _, _, rnn_states_actor, _ = self.get_actions(cent_obs,
                                                              obs,
                                                              rnn_states_actor,
                                                              rnn_states_critic,
                                                              masks,
